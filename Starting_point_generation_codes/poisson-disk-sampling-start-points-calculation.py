...
m.save(os.path.join(output_map_dir, "subzone_poisson_points_map.html"))
print("Map saved as subzone_poisson_points_map.html")

# Export subzone data to an Excel file
df = pd.DataFrame(subzone_data)
df.to_excel(os.path.join(output_map_dir, "subzone_poisson_points_data.xlsx"), index=False)
...
merged_df.to_excel(os.path.join(output_population_dir, "merged_poisson_subzone_population.xlsx"), index=False)

print("Merged data exported as merged_poisson_subzone_population.xlsx")
